...
def admin_only(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        return "You don't have admin permissions."
...
def show_post(post_id):
    ...
    comment_objs = db.session.execute(db.select(BlogComment).where(BlogComment.post_id == post_id))
    comments = comment_objs.scalars().all()
