...
def count_down(count):
    ...
    if reps % 2 == 0 and reps > 0:
        check_mark_lbl.config(text=int(reps/2) * "✓")
...
title_lbl = Label(text="Timer",bg=YELLOW, fg=GREEN, font=(FONT_NAME, 40, "normal"), highlightthickness=0)
...
check_mark_lbl = Label(bg=YELLOW, fg=GREEN, font=(FONT_NAME, 15, "bold"), highlightthickness=0)
